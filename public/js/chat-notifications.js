...
(function () {
    ...
    function injectStyles() {
        if (document.getElementById('_cn_styles'))
            return;
...
._cn_foot a:hover { text-decoration: underline; }
    ...
    function injectWidget() {
        if (document.getElementById('_cnWidget'))
            return;
    ...
    `;
        ...
        document.getElementById('_cnBell').addEventListener('click', function (e) {
            e.stopPropagation();
            toggleDrop();
        });
        document.getElementById('_cnMarkAll').addEventListener('click', function (e) {
            e.stopPropagation();
            markAllRead();
        });
    ...
    /* ── Real-time hook ─────────────────────────────────────────── */
    window.addEventListener('chatNewNotif', function (e) {
