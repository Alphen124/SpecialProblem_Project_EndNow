(function(){
  ...
  function wire(){
    ...
    document.addEventListener('click', (e)=>{
      ...
      if(cartPopup && !cartPopup.contains(e.target) && e.target.id !== 'headerCartBtn' && !e.target.closest('#miniCartPopup')) showMiniCart(false);
      const favPopup = document.getElementById('miniFavPopup');
      if(favPopup && !favPopup.contains(e.target) && e.target.id !== 'headerFavBtn' && !e.target.closest('#miniFavPopup')) showMiniFav(false);
    });
